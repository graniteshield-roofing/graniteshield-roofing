...
const config = TOWN_CONFIG[params.slug];
const faqs = [
...(config?.localFaqs || []),
{
question: `Do you serve ${town.name} year‑round?`,
answer: `Yes. We provide winter inspections, emergency repairs, and full installs in ${town.name}.`
},
{
question: 'Is financing available?',
answer: 'Yes — flexible plans available through our trusted lenders.'
},
];
...
return (
<>
<LocalServiceSchema townName={town.name} townSlug={town.slug} intro={config?.intro} />
<FAQSchema faqs={faqs} />
<BreadcrumbSchema
items={[
